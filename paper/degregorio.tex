...
are not in conflict, and are not the same object: their profiles carry
$c_l \ne 0$ and therefore narrow, which in the language of Section
\ref{sec:regimes} places them in the narrowing regime, whereas a frozen profile
requires $c_l = 0$ exactly. The natural reading is that the two are
complementary halves of one exchange of stability, in which the narrowing
attractor gives way to the frozen one. We record this as a hypothesis rather
than a result: the domains differ, circle against line, and we have not
computed their profile.
