...
None of these references performs the local analysis at stagnation points which
gives Propositions \ref{prop:exponent} and \ref{prop:c1}, nor the linear
stability computation of Section \ref{sec:spectrum}. Two numerical coincidences with
...
verified. Five closely related works, \cite{osw2008}, \cite{htw2022},
\cite{hqww2023}, \cite{gj2025} and \cite{htw2026}, have been read for overlap
and none contains Propositions \ref{prop:exponent} or \ref{prop:c1}, the
stability computation, or the regularity statement. One further paper of the
same group, arXiv:2401.14615 on multi scale self similar blowup, has not been
checked. This is a narrower check than a full literature survey:
