...
A pattern runs through all of these. Every construction we are aware of works
on the real line with a narrowing profile, $c_l\ne0$. The circle behaves
...
and in which the local relations below have content. None of these references
performs the local analysis at stagnation points which gives Propositions
\ref{prop:exponent} and \ref{prop:c1}, nor the linear stability computation of
Section \ref{sec:spectrum}. Two numerical coincidences with
...
verified. Seven closely related works, \cite{osw2008}, \cite{htw2022},
\cite{hqww2023}, \cite{hqw2024}, \cite{zheng2023}, \cite{gj2025} and
\cite{htw2026}, have been read for overlap and none contains Propositions
\ref{prop:exponent} or \ref{prop:c1}, the stability computation, or the
regularity statement. We note that this list grew twice while being compiled,
so it should be read as the nearest work we could find rather than as a
complete survey. This is a narrower check than a full literature survey:
