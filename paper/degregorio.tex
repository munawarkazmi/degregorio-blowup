...
computation of Section \ref{sec:spectrum}. Two points of contact deserve
attention rather than dismissal. First, \cite{htw2026} reports a structural
transition at $a^{c,2}\approx 0.751$, which is close to where the frozen regime
begins here, and the two may be the same phenomenon seen on different domains.
Second, \cite{htw2026} obtains an exponent $1/(1-a)$ for its singular profiles
at $a<0$, algebraically identical to the closed form of Proposition
\ref{prop:c1} although attached to a different quantity. Whether either is a
coincidence is open.
...
verification of every lemma. The two points of contact noted in Section 1,
the transition near $a\approx 0.75$ and the recurrence of the constant
$1/(1-a)$, should be settled before any priority claim is made.
