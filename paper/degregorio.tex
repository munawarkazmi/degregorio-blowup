...
$a=1$ model. Table \ref{tab:generic} shows the same profile reached from three
sign changing data and, up to Proposition \ref{prop:dilation}, from a fourth
built entirely from higher modes, which removes the worst form of this
objection. It does not remove all of it. Four data are not a survey, all four
are trigonometric polynomials of low degree, and Remark \ref{rem:onesigned}
shows that data of one sign behave completely differently. What the basin of
the frozen profile actually looks like is unexamined.
